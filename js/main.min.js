...
document.addEventListener("DOMContentLoaded",function(e){const t=document.querySelector("body"),s=document.querySelector(".header__burger"),o=document.querySelector(".burger__nav"),l=document.querySelector(".burger__bg"),r=(s.addEventListener("click",()=>{s.classList.toggle("active"),o.classList.toggle("active"),l.classList.toggle("active"),t.classList.toggle("lock")}),()=>{s.classList.remove("active"),o.classList.remove("active"),l.classList.remove("active"),t.classList.remove("lock")}),i=(l.addEventListener("click",r),document.querySelectorAll(".burger__link").forEach(e=>{e.addEventListener("click",function(e){e.preventDefault();e=this.getAttribute("href").substring(1);const t=document.getElementById(e);e=t.getBoundingClientRect().top;r(),window.scrollBy({top:e,behavior:"smooth"})})}),document.querySelector(".toTop"));window.addEventListener("scroll",function(){100<this.scrollY?i.classList.add("show"):i.classList.remove("show")}),i.addEventListener("click",()=>{const e=document.getElementById("top");var t=e.getBoundingClientRect().top;window.scrollBy({top:t,behavior:"smooth"})});new Swiper(".works__slider",{loop:!1,spaceBetween:20,slidesPerView:1,slidesPerGroup:1,draggable:!0,pagination:{el:".works__nav",type:"bullets",bulletClass:"works__dot",bulletActiveClass:"works__dot-active",clickable:"true"},breakpoints:{576:{slidesPerView:2,slidesPerGroup:2},992:{slidesPerView:3,slidesPerGroup:3}}})});