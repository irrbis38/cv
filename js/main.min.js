...
document.addEventListener("DOMContentLoaded",function(e){const t=document.querySelector("body"),o=document.querySelector(".header__burger"),c=document.querySelector(".burger__nav"),s=document.querySelector(".burger__bg"),n=(o.addEventListener("click",()=>{o.classList.toggle("active"),c.classList.toggle("active"),s.classList.toggle("active"),t.classList.toggle("lock")}),()=>{o.classList.remove("active"),c.classList.remove("active"),s.classList.remove("active"),t.classList.remove("lock")}),r=(s.addEventListener("click",n),document.querySelectorAll(".burger__link").forEach(e=>{e.addEventListener("click",function(e){e.preventDefault();e=this.getAttribute("href").substring(1);const t=document.getElementById(e);e=t.getBoundingClientRect().top;n(),window.scrollBy({top:e,behavior:"smooth"})})}),document.querySelector(".toTop"));window.addEventListener("scroll",function(){100<this.scrollY?r.classList.add("show"):r.classList.remove("show")}),r.addEventListener("click",()=>{const e=document.getElementById("top");var t=e.getBoundingClientRect().top;window.scrollBy({top:t,behavior:"smooth"})})});